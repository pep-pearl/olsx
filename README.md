...
```tsx
import { BaseLayer, OLSXMap, OLSXTileLayer, OLSXVectorLayer } from "olx";
```
...
- 고급 OpenLayers 동작은 현재 `useMapRefsContext` 또는 `useMountLayer` 기반 custom component/hook으로 구현하는 것을 권장합니다.
